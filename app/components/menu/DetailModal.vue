      ...
      <div class="mt-5 grid gap-5 md:grid-cols-[minmax(0,_320px)_1fr]">
        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="mt-auto flex items-center gap-3">
            <button
              class="flex-1 min-w-0 rounded-xl bg-brand-600 py-3 text-white hover:bg-brand-700"
            ...
            >
              ...
              <span class="sr-only">{{ favoriteActionLabel }}</span>
            </button>
          </div>
        </div>
      </div>
...
const favoriteActionLabel = computed(() => {
  if (!props.item) return 'Добавить в избранное'
  return isCurrentFavorite.value ? 'Убрать из избранного' : 'Добавить в избранное'
})
